...
const Home = () => {
  return (
    <div className='bg-[#31363F] flex flex-col md:flex-row w-auto pb-16 items-center'>
      ...
      <div className='md:ml-12 text-center md:text-left text-MySalat font-Montserrat my-8 md:my-0'>
        <h1 className='text-white text-5xl mb-3 font-semibold'>Hisham Khan</h1>
        <h2 className='text-2xl mb-4 text-white'>Full Stack Developer</h2>
