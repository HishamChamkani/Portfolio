...
const Footer = () => {
  return (
    <div>
      <div className='bg-MyDark font-Montserrat text-center pb-8'>
            <h1 className='text-white text-2xl'>Let us Create Awesome Products!</h1>
            <p className='text-MySalat'>I am always open to discussing your project, 
            improving your online presence, or helping with <br/> Your website design and 
            converting challenges.
            </p>
          </div>
        <footer className="bg-DarkBlue py-6 font-Montserrat border-t">
        <p className='container mx-auto text-center text-xl text-white'>Contact Me</p>
        <div className="container mx-auto text-center text-lg text-MySalat my-8 flex justify-center">
